...
target_plot, = ax.plot([], [], 'gx', markersize=10, label='Target Point')

axcolor = 'lightgoldenrodyellow'
ax_robo_x = plt.axes([0.25, 0.13, 0.65, 0.03], facecolor=axcolor)
ax_robo_y = plt.axes([0.25, 0.18, 0.65, 0.03], facecolor=axcolor)
...
ax_oppo_x = plt.axes([0.25, 0.08, 0.65, 0.03], facecolor=axcolor)
ax_oppo_y = plt.axes([0.25, 0.03, 0.65, 0.03], facecolor=axcolor)
...
slider_level = Slider(plt.axes([0.25, 0.23, 0.65, 0.03], facecolor=axcolor), 'Level', 0, 3, valinit=1, valstep=1)

ax_fire = plt.axes([0.8, 0.29, 0.1, 0.04])
